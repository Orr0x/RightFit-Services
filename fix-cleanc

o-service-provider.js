 ...
 *
 * Creates/updates a service provider for the CleanCo test tenant
 * with the hardcoded ID used throughout the web-cleaning app.
 */
...
O_TENANT_ID = 'tenant-cleaning-test';
