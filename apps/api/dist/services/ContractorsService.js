...
class ContractorsService {
    ...
    async getById(tenantId, contractorId) {
    ...
    async update(tenantId, contractorId, data) {
    ...
    async delete(tenantId, contractorId) {
        const contractor = await prisma.contractor.findFirst({
            where: {
                id: contractorId,
                tenant_id: tenantId,
    ...
    async getByTrade(tenantId, trade) {
...
exports.default = new ContractorsService();
//# sourceMappingURL=ContractorsService.js.map