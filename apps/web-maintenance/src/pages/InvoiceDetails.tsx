...
import { Button, Card, Badge, Spinner, Modal, Input, Select, type SelectOption } from '@rightfit/ui-core';
import { useToast } from '../components/ui';
import { useLoading } from '../hooks/useLoading'
import { maintenanceInvoicesAPI, type MaintenanceInvoice } from '../lib/api'
...
export default function InvoiceDetails() {
  ...
  const [invoice, setInvoice] = useState<MaintenanceInvoice | null>(null)
  ...
  const loadInvoice = async () => {
    try {
      ...
      const data = await maintenanceInvoicesAPI.get(id!)
      setInvoice(data)
    } catch (err: any) {
  ...
  const handleMarkAsPaid = async () => {
    await withLoading(async () => {
      try {
        await maintenanceInvoicesAPI.markAsPaid(id!, {
          paid_date: paidDate,
  ...
  const handleDelete = async () => {
    ...
    await withLoading(async () => {
      try {
        await maintenanceInvoicesAPI.delete(id!)
