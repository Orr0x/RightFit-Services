  ...
  useEffect(() => {
    const loadProperties = async () => {
      ...
      try {
        ...
        const result = await propertiesAPI.list({ customer_id: customerId })
    ...
    await withLoading(async () => {
      try {
        ...
        const quoteData: CreateQuoteData = {
          ...
          valid_until_date: String(validUntil),
          ...
          notes: serviceDescription ? `${serviceDescription}\n\n${notes}` : notes,
        }

        console.log('Sending quote data:', quoteData)
        const quote = await maintenanceQuotesAPI.create(quoteData)
      ...
      <Card className="p-6">
        ...
        >
          ...
          <div className="flex gap-4 mt-8 pt-6 border-t">
            ...
            <Button type="button" variant="secondary" onClick={() => navigate('/quotes')} disabled={isLoading}>
              Cancel
            </Button>
          </div>
        </form>
