...
export default function PropertyCalendar() {
  ...
  const validateJobReschedule = async (job: MaintenanceJob, newDateStr: string): Promise<{ valid: boolean; message?: string }> => {
  ...
  // Handle drag start
  const handleDragStart = (e: React.DragEvent, job: MaintenanceJob, dateStr: string) => {
  ...
  // Handle quick edit
  const handleQuickEdit = (e: React.MouseEvent | React.Touch, job: MaintenanceJob) => {
    e.stopPropagation() // Prevent navigation to job details
    setEditingJob(job)
  }

  // Handle right-click
  const handleContextMenu = (e: React.MouseEvent, job: MaintenanceJob) => {
